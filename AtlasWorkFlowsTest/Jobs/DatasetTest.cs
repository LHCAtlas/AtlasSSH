...
namespace AtlasWorkFlowsTest.Jobs
{
    ...
    public class DatasetTest
    {
        ...
        public void xAODMCDataset()
        {
            ...
            Assert.AreEqual("user.bogus.361020.Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ0W.e3569_s2576_s2132_r6765_r6282.DiVertAnalysis_v22_3B233454", ds);
        }
        ...
        public void DxAODDatasetFromEmma()
        {
            ...
            Assert.AreEqual("user.bogus.361023.Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ3W.s2132_r6765_r6282__EXOT15_EXT0.DiVertAnalysis_v22_3B233454", ds);
        }
        ...
        public void LatestreamDS()
        {
            ...
            Assert.AreEqual("user.bogus.00277025.physics_Late.DAOD_EXOT15.f622_m1486_p2425.DiVertAnalysis_v22_3B233454", ds);
        }
        ...
        public void DataDerivationxAOD()
        {
            ...
            Assert.AreEqual("user.bogus.00280500.physics_Main.DAOD_EXOT15.f631_m1504_p2425.DiVertAnalysis_v22_3B233454", ds);
        }
